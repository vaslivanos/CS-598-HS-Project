...
if it remained in a theoretical level. To this end, we gather data from real online social networks (i.e. Twitter and
StackExchange) in order to understand whether the observations from real social networks are similar to the predictions of our
model.
